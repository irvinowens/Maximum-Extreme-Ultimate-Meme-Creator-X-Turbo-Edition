...
import us.sigsegv.android.maximumultimatememecreatorxturbo.Gallery.OnScrollStoppedListener;
import us.sigsegv.android.maximumultimatememecreatorxturbo.util.AnimationsHelper;
import us.sigsegv.android.maximumultimatememecreatorxturbo.util.DiskLruImageCache;
...
public class ChooseTenSecondClip extends Activity {
	...
	protected void onResume() {
		...
		mHsv.setOnScrollStoppedListener(new OnScrollStoppedListener(){
	...
	private String getVideoMimeDetails(){
		if(this.mVideoUri == null){
			return null;
		}
